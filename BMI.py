...
L = ttk.Label(GUI, text='กรอกตัวเลขลงช่องว่างเพื่อหาBMI ', font=FONT2).pack(pady=10)
v_weight = StringVar()
v_height = StringVar()
...
def Calculate(event=None):
    try:
        ...
        messagebox.showwarning('Erro', 'โปรดกรอกตัวเลขอย่างเดียวและให้ครบทั้งสองช่องนะครับ -^-')
        v_weight.set('')
        v_height.set('')
        E1.focus()
